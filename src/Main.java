public class Main {
    ...
    public static void testNaive() {
        ...
        for (int i = 0; i < smallSizes.length; i++) {
            ...
            long result = Fibonacci.fibNaive(n);
            long end = System.nanoTime();

            long time = end - start;

            System.out.println("N = " + n + " | Результат = " + result + " | Час: " + time + " наносекунд");
        }
    }
    ...
    public static void testOptimizedVsArray() {
        ...
        for (int i = 0; i < sizes.length; i++) {
            ...
            System.out.println("Спосіб з масивом:        Результат = " + result1 + " | Час = " + time1 + " мкс, Пам'ять = " + memoryUsed1 + " КБ");

            System.gc();
            long memoryBefore2 = runtime.totalMemory() - runtime.freeMemory();

            long start2 = System.nanoTime();
            long result2 = Fibonacci.fibOptimized(n);
            ...
            System.out.println("Спосіб з двома змінними: Результат = " + result2 + " | Час = " + time2 + " мкс, Пам'ять = " + memoryUsed2 + " КБ");
        }
    }
}